...
The name of the Game is Lines of Action (LOA), which is a board game.

The heurestics used in this implementation are followings::
...
Experimentaion
Finally, we may experiment by taking some (or all) of these features and construct an evaluation function by taking a weighted sum or a weighted average.
